...
Resolver::resolveRouteRegistrar()
    ...
    ->group(static function (Router $router): void {
        ...
        $router->get('recipes/{recipe}/setup', [RecipeController::class, 'setup']);
        $router->post('recipes/{recipe}/setup', [RecipeController::class, 'updateSetup']);
        $router->post('recipes/{recipe}/sample', [RecipeController::class, 'sample']);
        $router->post('recipes/{recipe}/notifications', [RecipeController::class, 'notifications']);
        $router->post('recipes/{recipe}/connections', [RecipeController::class, 'connection']);
        $router->post('recipes/{recipe}/connections/{connection}/revoke', [RecipeController::class, 'revokeConnection']);
        $router->post('recipes/{recipe}/browser', [RecipeController::class, 'browser']);
        $router->post('recipes/{recipe}/preview', [RecipeController::class, 'preview']);
        $router->post('recipes/{recipe}/schedule', [ScheduleController::class, 'update']);
        $router->post('recipes/{recipe}/schedule/pause', [ScheduleController::class, 'pause']);
        $router->post('recipes/{recipe}/schedule/resume', [ScheduleController::class, 'resume']);
        $router->post('recipes/{recipe}/schedule/run-now', [ScheduleController::class, 'runNow']);
